    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(indoor.this, TableReservation.class);
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() { // Corrected this block
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(indoor.this, Tablepax.class);
                startActivity(intent);
            }
        });
    }
        ...
        timePickerDialog = new TimePickerDialog(
                ...
                new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker timePicker, int hourOfDay, int minute) {
                        ...
                        Toast.makeText(indoor.this, "Hour: " + hourOfDay + ", Minute: " + minute, Toast.LENGTH_SHORT).show();
                    }
                },
                hourOfDay,
                minutes,
